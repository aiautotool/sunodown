...
.v7-workspace article{background:linear-gradient(180deg,#0a1525,#08121f)!important;border:1px solid rgba(148,163,184,.11)!important;border-radius:16px!important}
.v7-workspace input{background:#0a1728!important}
.v10-dashboard{display:grid;gap:12px}
.v10-dashboard>*{min-width:0}
...
@media(min-width:1180px){
 ...
 .mobile-song-card{padding:14px!important}
 #studio-editor{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important}
 #studio-editor>section:first-of-type,#studio-editor>#v5-video-preset-gallery,#studio-editor>#effects-slot{grid-column:1/-1}
 #render-zone{margin-top:10px!important}
}
...
@media(max-width:767px){
 ...
 .mobile-song-head h2{font-size:15px!important}.mobile-song-head audio{height:34px!important;margin-top:4px!important}
 .mobile-studio{display:grid!important;grid-template-columns:minmax(0,1fr)!important;overflow:visible!important;gap:9px!important}
 .mobile-studio>*{max-height:none!important;overflow:visible!important;border-radius:15px!important}
 .v5-preset-track,.v8-effects-track{display:grid!important;grid-auto-flow:column!important;grid-auto-columns:78%!important;overflow-x:auto!important;scroll-snap-type:x mandatory!important;-webkit-overflow-scrolling:touch!important;padding-bottom:8px!important}
 .v8-effects-track{grid-auto-columns:108px!important;gap:8px!important}.v5-preset-track>*,.v8-effects-track>*{scroll-snap-align:start!important}
 .mobile-render-zone{margin-bottom:72px!important;padding:11px!important}
 .mobile-render-zone>div.grid{position:sticky!important;bottom:64px!important;z-index:30!important;display:grid!important;grid-template-columns:1fr 1.25fr!important;padding:7px!important;margin:8px -4px -4px!important;border:1px solid rgba(99,102,241,.25)!important;border-radius:15px!important;background:rgba(5,11,21,.94)!important;backdrop-filter:blur(16px)!important}
