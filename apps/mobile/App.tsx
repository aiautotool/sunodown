...
const styles = StyleSheet.create({
  ...
  coverFallback:{position:'absolute',top:0,right:0,bottom:0,left:0,backgroundColor:'#111827'},
  previewOverlay:{position:'absolute',top:0,right:0,bottom:0,left:0,borderWidth:2,borderRadius:26,backgroundColor:'rgba(2,6,23,.44)',padding:22,justifyContent:'flex-end'},
