...
export const BUILTIN_STUDIO_PRESETS:StudioPreset[] = [
  ...
  {schemaVersion:2,id:'karaoke-pop',name:'Karaoke Pop',description:'Lyric rõ, highlight từng câu và bố cục cân bằng để hát theo hoặc cắt social clip.',category:'Lyrics',badge:'Karaoke',accent:'#f43f5e',secondary:'#fb7185',builtin:true,config:{template:'lyrics-focus',wave:'mirror',motion:'medium',aspect:'16:9',lyrics:'focus',effects:['bokeh'],layout:layout(84,56,17,25,100,132,104),textStyles:text("'Trebuchet MS', sans-serif",'system-ui, sans-serif'),subtitleStyle:{font:'rounded',color:'#ffffff',activeColor:'#fb7185'},background:bg('romantic-glow',18,18)}},
  {schemaVersion:2,id:'gold-premiere',name:'Golden Premiere',description:'Ra mắt ca khúc theo phong cách luxury: đĩa vàng, serif, glow nhẹ và film grain cao cấp.',category:'Cinematic',badge:'Launch',accent:'#fbbf24',secondary:'#92400e',builtin:true,config:{template:'gold-record',wave:'dots',motion:'low',aspect:'16:9',lyrics:'off',effects:['dust','film','vignette'],layout:layout(87,73,20,29,86,90,106),textStyles:text('Georgia, serif','Georgia, serif','#fef3c7','#fde68a'),subtitleStyle:{font:'serif',color:'#fff7ed',activeColor:'#fbbf24'},background:bg('bokeh-night',26,10)}},

  {schemaVersion:2,id:'reels-velocity',name:'Reels Velocity',description:'Nhịp nhanh cho Reels/Shorts: waveform lớn, title gọn và ánh sáng neon chuyển động mạnh.',category:'Social',badge:'New',accent:'#22d3ee',secondary:'#a855f7',builtin:true,config:{template:'spotlight',wave:'wave-bars',motion:'high',aspect:'9:16',lyrics:'focus',effects:['sparkles','lightleak','vignette'],layout:layout(79,59,16,24,124,118,108),textStyles:text('Impact, sans-serif',"'Trebuchet MS', sans-serif",'#ecfeff','#a5f3fc'),subtitleStyle:{font:'rounded',color:'#ffffff',activeColor:'#22d3ee'},background:bg('dreamy-blue',14,20)}},
  {schemaVersion:2,id:'story-confession',name:'Confession Story',description:'Tập trung lời kể và lyric, nhịp chậm, nền tối mềm cho video tâm sự và storytelling.',category:'Lyrics',badge:'Story',accent:'#c084fc',secondary:'#64748b',builtin:true,config:{template:'lyrics-focus',wave:'ribbon',motion:'low',aspect:'9:16',lyrics:'scroll',effects:['film','dust','vignette'],layout:layout(89,55,19,27,84,108,94),textStyles:text('Georgia, serif','system-ui, sans-serif','#faf5ff','#cbd5e1'),subtitleStyle:{font:'serif',color:'#f8fafc',activeColor:'#d8b4fe'},background:bg('dark-film',34,12)}},
  {schemaVersion:2,id:'midnight-drive',name:'Midnight Drive',description:'Không khí thành phố về đêm cho synthpop, chillwave và late-night tracks.',category:'Visualizer',badge:'Night',accent:'#38bdf8',secondary:'#818cf8',builtin:true,config:{template:'glass-card',wave:'mountain',motion:'medium',aspect:'16:9',lyrics:'off',effects:['stars','bokeh','vignette'],layout:layout(82,74,18,27,108,90,102),textStyles:text("'Trebuchet MS', sans-serif",'system-ui, sans-serif','#e0f2fe','#bae6fd'),subtitleStyle:{font:'system',color:'#ffffff',activeColor:'#38bdf8'},background:bg('dreamy-blue',22,20)}},
  {schemaVersion:2,id:'acoustic-room',name:'Acoustic Journal',description:'Ấm, tối giản và gần gũi cho acoustic/live session với typography mềm và hiệu ứng tiết chế.',category:'Album',badge:'Acoustic',accent:'#f59e0b',secondary:'#d6d3d1',builtin:true,config:{template:'cover-motion',wave:'line',motion:'low',aspect:'4:5',lyrics:'scroll',effects:['dust','vignette'],layout:layout(87,70,17,25,88,94,98),textStyles:text('Georgia, serif','system-ui, sans-serif','#fff7ed','#e7e5e4'),subtitleStyle:{font:'serif',color:'#fff7ed',activeColor:'#fbbf24'},background:bg('soft-light',18,5)}},
  {schemaVersion:2,id:'festival-energy',name:'Festival Pulse',description:'Visualizer năng lượng cao cho EDM/live set với vòng sóng lớn, sparkle và concert lighting.',category:'Visualizer',badge:'Live',accent:'#f472b6',secondary:'#22d3ee',builtin:true,config:{template:'spotlight',wave:'spectrum-rings',motion:'high',aspect:'16:9',lyrics:'off',effects:['sparkles','stars','lightleak'],layout:layout(66,78,15,23,138,90,112),textStyles:text('Impact, sans-serif',"'Courier New', monospace",'#fdf4ff','#a5f3fc'),subtitleStyle:{font:'impact',color:'#ffffff',activeColor:'#f472b6'},background:bg('concert-light',10,24)}},
  {schemaVersion:2,id:'romantic-letter',name:'Romantic Letter',description:'Thư tình điện ảnh với serif thanh lịch, lyric rõ và glow hồng dịu cho love songs.',category:'Cinematic',badge:'Love',accent:'#fb7185',secondary:'#fda4af',builtin:true,config:{template:'editorial',wave:'thin-bars',motion:'low',aspect:'16:9',lyrics:'focus',effects:['bokeh','film','vignette'],layout:layout(89,63,18,27,82,110,106),textStyles:text('Georgia, serif','Georgia, serif','#fff1f2','#fecdd3'),subtitleStyle:{font:'serif',color:'#fff1f2',activeColor:'#fb7185'},background:bg('romantic-glow',24,14)}},
  {schemaVersion:2,id:'podcast-wave',name:'Podcast Clean',description:'Bố cục sạch cho spoken-word, podcast và audio snippets; waveform dễ đọc, ít nhiễu.',category:'Social',badge:'Voice',accent:'#10b981',secondary:'#94a3b8',builtin:true,config:{template:'glass-card',wave:'center-line',motion:'low',aspect:'1:1',lyrics:'scroll',effects:['vignette'],layout:layout(80,67,18,27,106,92,100),textStyles:text('system-ui, sans-serif','system-ui, sans-serif','#f8fafc','#cbd5e1'),subtitleStyle:{font:'system',color:'#ffffff',activeColor:'#34d399'},background:bg('dark-film',24,4)}},
  {schemaVersion:2,id:'retro-vinyl',name:'Warm Retro Vinyl',description:'Vinyl retro với film grain và tông ấm dành cho soul, jazz, oldies và acoustic cổ điển.',category:'Album',badge:'Retro',accent:'#fbbf24',secondary:'#a16207',builtin:true,config:{template:'vinyl',wave:'orbit-dots',motion:'medium',aspect:'1:1',lyrics:'off',effects:['film','dust','vignette'],layout:layout(73,82,15,23,116,90,102),textStyles:text('Georgia, serif',"'Courier New', monospace",'#fef3c7','#fde68a'),subtitleStyle:{font:'serif',color:'#fff7ed',activeColor:'#fbbf24'},background:bg('bokeh-night',30,8)}},
];
