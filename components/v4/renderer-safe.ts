...
export type SafeRenderOptions={motion:MotionIntensity;lyrics:LyricsMode;layout?:OverlayLayout;karaokeTimeline?:KaraokeLine[];background?:BackgroundConfig;loopDuration?:number;startSeconds?:number;previewSeconds?:number;onProgress?:(value:number)=>void};
