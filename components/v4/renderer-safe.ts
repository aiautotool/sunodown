...
export type SafeRenderOptions={motion:MotionIntensity;lyrics:LyricsMode;karaokeTimeline?:KaraokeLine[];background?:BackgroundConfig;loopDuration?:number;startSeconds?:number;previewSeconds?:number;onProgress?:(value:number)=>void};
...
function drawWave(ctx:CanvasRenderingContext2D,samples:Float32Array|null,rate:number,t:number,w:number,h:number,style:WaveStyle,p:Palette){
